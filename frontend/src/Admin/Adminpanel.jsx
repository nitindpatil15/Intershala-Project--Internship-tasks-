...
function Adminpanel() {
  return (
    <div>
      <div class="w-full overflow-hidden rounded-lg border bg-gray-50 shadow-sm lg:block">
        <div class="mx-auto flex max-w-screen-lg items-center gap-8 p-8">
          <div class="flex flex-col md:flex-row">
            <Link to="/applications" class="group flex gap-4 m-4">
            ...
            <Link to={"/postJob"} class="group flex gap-4 m-4">
              <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-indigo-500 text-white shadow-lg transition duration-100 group-hover:bg-indigo-600 group-active:bg-indigo-700 md:h-12 md:w-12">
            ...
            <Link to={"/postInternship"} class="group flex gap-4 m-4">
              <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-indigo-500 text-white shadow-lg transition duration-100 group-hover:bg-indigo-600 group-active:bg-indigo-700 md:h-12 md:w-12">
                <RiSendPlaneFill />
              </div>
              <div>
